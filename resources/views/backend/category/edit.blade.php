...
<form class="needs-validation" novalidate action="{{route('admin.category.update',$category->slug)}}" method="post" enctype='multipart/form-data' >
@csrf
@method('PUT')
<div class="form-row">
<div class="col-md-12">
        ...
        <textarea class="form-control" name='disc' id="validationCustom0disc" rows="3">{{$category->disc}}</textarea>
...
<div class="col-md-6">
    ...
    <input type="text" class="form-control" id="validationCustom02" value="{{$category->name}}"  name="name"  required>
